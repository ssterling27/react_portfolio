    ...
    <>
      <div style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center' }}>
        <div className='content'>
          ...
          <p className='paragraph' style={{ color: 'white', marginLeft: '2%', marginRight: '2%', marginBottom: '2%' }}>Hi, I'm Sam. I'm relatively new to the world of web development, but I've made great progress in a short amount of time. I'm experienced in HTML, CSS, JavaScript, React, database architecture, and more. It may seem doubtful for me to have a true grasp of these topics given their depth and the short time span, but I've put in a huge amount of effort and have gotten great results. You can check out my projects and skills below for yourself. I'm confident in my ability to get results and hone my skills even further as I continue to learn. Whatever the challenge, I'm up for it.</p>
        </div>
      </div>
